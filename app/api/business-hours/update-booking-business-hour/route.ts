...
export async function POST(req: Request) {
    try {
        ...
        const result = await bookingBusinessHoursService.updateBookingBusinessHour(bookingSetupCode, bookingBusinessHoursDayOfWeek, bookingBusinessHoursStartTime, bookingBusinessHoursEndTime, bookingBusinessHoursTimeIncrement,);
