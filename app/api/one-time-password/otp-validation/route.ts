...
async function validateOTP(
  ...
  const url = `https://api.businesscentral.dynamics.com/v2.0/${tenantId}/${environment}/ODataV4/BookingAppointment_OTPValidation?Company=${company}`;

  const requestBody = {
    _RequestId: body._RequestId,
    _OTP: body._OTP,
  };
